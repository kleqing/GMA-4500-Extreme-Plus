...
  Microsoft Windows 10 x64
  ...
  Driver Revision: 20.21.7.6464 (2869 Mod)
  March 3, 2021
...
  1 An accelerated modification by : nIGHTmAYOR
  2 This modification fixes issues like :
	...
	b. Fix crashes after resuming from sleep or hibernation
	c. Upgrading to final version of Intel Control Panel
	d. Fixing OpenGL32 apps crashing
	e. Merging all previous tweaks done by previous modders
	f. Inclusion of Turbo Booster by Intel and Display Audio
	g. Absence of Power Options support
	h. More stability on DCH builds of Windows 10
	i. Now supporting First Generation Intel Core i
